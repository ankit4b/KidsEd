        ...
        <ScrollView style={{backgroundColor:"#fff"}}>
            ...
            <View style={styles.container}>
                <SubjectCard
                    ...
                    imagesrc = {englishImg}
                    height = {100}
                    onPress = {() => {navigation.navigate('Age3_5_CocurricularChapters', {chapters : data.curricular.english.chapters})}}
                />  
                <SubjectCard
                    subjectName = "Math"
                    imagesrc = {mathImg}
                ...
                <SubjectCard
                    ...
                    imagesrc = {hindiImg}
                    height = {100}
                    onPress = {() => {navigation.navigate('Age3_5_CocurricularChapters', {chapters : data.curricular.hindi.chapters})}}
                />  
