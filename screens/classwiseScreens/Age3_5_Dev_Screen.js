...
const Age3_5_Dev_Screen= ({navigation}) => {
            ...
            <View style={styles.container}>
                    <View style={{flexDirection:"row", paddingVertical:20,}}>
                        ...
                        <View style={{flex: 2,  justifyContent:"center", alignItems:"center"}}>
                            ...
                            <TouchableOpacity style={{marginTop: 10}}
                                onPress={() => navigation.navigate("Age3_5_CurricularSubjects")}
                                >
                    ...
                    <View style={{flexDirection:"row", paddingVertical:20,}}>
                        ...
                        <View style={{flex: 2,  justifyContent:"center", alignItems:"center"}}>
                            ...
                            <TouchableOpacity style={{marginTop: 10}}
                                onPress={() => navigation.navigate("Age3_5_CocurricularSubjects")}
                                >
                                <View style={{flexDirection:"row", backgroundColor:"#240a8a", padding:4, paddingLeft: 10, borderRadius:5,  marginRight: 30, alignItems:"center"}}>
                                    <Text style={{ fontSize: 15, fontWeight:"bold", color:"#fff"}}>
                                        Start
...
export default Age3_5_Dev_Screen;
